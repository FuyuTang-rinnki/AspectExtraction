...
if __name__ == "__main__":
    ...
    config = {'num_labels': 3, 'dropout_prob': 0.50, 'lr': args.lr, 'batch_size': args.batch_size,
              'max_norm': 1., 'nums_filter': [128, 256], 'kernel_sizes': [5, 3, 5], 'nums_words': [2, 1], 'epsilon': 0.01}
